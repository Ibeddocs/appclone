...
const Testimonials = () => {
  return (
    ...
    {/* title */}
        ...
        <h1 className='text-center text-2xl md:text-3xl lg:text-4xl font-extralight bg-gradient-to-r from-slate-900 to-slate-400 bg-clip-text text-transparent'>Customer Testimoni</h1>
